...
{
    public function testCanCreateWhatsAppContactMessageResourceWithAllData(): void
    {
        // arrange
        $from = 'from';
        $to = 'to';
    ...
    public function testCanCreateWhatsAppContactMessageResourceWithPartialData(): void
    {
        // arrange
        $from = 'from';
        $to = 'to';
